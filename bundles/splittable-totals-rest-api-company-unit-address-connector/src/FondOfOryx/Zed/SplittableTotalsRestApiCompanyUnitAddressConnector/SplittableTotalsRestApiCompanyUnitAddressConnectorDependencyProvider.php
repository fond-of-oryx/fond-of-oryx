...
class SplittableTotalsRestApiCompanyUnitAddressConnectorDependencyProvider extends AbstractBundleDependencyProvider
{
    ...
    protected function addCompanyUnitAddressFacade(Container $container): Container
    {
        $container[static::FACADE_COMPANY_UNIT_ADDRESS] = static function (Container $container) {
            return new SplittableTotalsRestApiCompanyUnitAddressConnectorToCompanyUnitAddressFacadeBridge(
