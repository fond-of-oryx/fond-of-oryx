...
class LogAwsCloudWatchConnectorConfig extends BaseLogConfig
{
    ...
    {
        return $this->get(LogAwsCloudWatchConnectorConstants::AWS_LOG_GROUP_NAME_GLUE, LogAwsCloudWatchConnectorConstants::AWS_LOG_GROUP_NAME_GLUE_DEFAULT_VALUE);
    }
    ...
    {
        return $this->get(LogAwsCloudWatchConnectorConstants::AWS_LOG_STREAM_NAME_GLUE, LogAwsCloudWatchConnectorConstants::AWS_LOG_STREAM_NAME_GLUE_DEFAULT_VALUE);
    }
    ...
    {
        return (int)$this->get(LogAwsCloudWatchConnectorConstants::AWS_LOG_LEVEL_GLUE, LogAwsCloudWatchConnectorConstants::AWS_LOG_LEVEL_GLUE_DEFAULT_VALUE);
    }
