...
class LogAwsCloudWatchConnectorConfig extends BaseLogConfig
{
    ...
    {
        return $this->get(LogAwsCloudWatchConnectorConstants::AWS_LOG_GROUP_NAME_ZED, LogAwsCloudWatchConnectorConstants::AWS_LOG_GROUP_NAME_ZED_DEFAULT_VALUE);
    }
    ...
    {
        return $this->get(LogAwsCloudWatchConnectorConstants::AWS_LOG_STREAM_NAME_ZED, LogAwsCloudWatchConnectorConstants::AWS_LOG_STREAM_NAME_ZED_DEFAULT_VALUE);
    }
    ...
    {
        return (int)$this->get(LogAwsCloudWatchConnectorConstants::AWS_LOG_LEVEL_ZED, LogAwsCloudWatchConnectorConstants::AWS_LOG_LEVEL_ZED_DEFAULT_VALUE);
    }
