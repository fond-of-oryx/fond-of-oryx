...
class LogAwsCloudWatchConnectorConfigTest extends Unit
{
    ...
    public function testGetAwsLogGroupName(): void
    {
        $this->config->expects(static::atLeastOnce())
            ->method('get')
            ->withConsecutive(
                [LogAwsCloudWatchConnectorConstants::AWS_LOG_GROUP_NAME_GLUE, LogAwsCloudWatchConnectorConstants::AWS_LOG_GROUP_NAME_GLUE_DEFAULT_VALUE],
            )->willReturnOnConsecutiveCalls(
                LogAwsCloudWatchConnectorConstants::AWS_LOG_GROUP_NAME_GLUE_DEFAULT_VALUE,
            );
    ...
    public function testGetAwsLogStreamName(): void
    {
        $this->config->expects(static::atLeastOnce())
            ->method('get')
            ->withConsecutive(
                [LogAwsCloudWatchConnectorConstants::AWS_LOG_STREAM_NAME_GLUE, LogAwsCloudWatchConnectorConstants::AWS_LOG_STREAM_NAME_GLUE_DEFAULT_VALUE],
            )->willReturnOnConsecutiveCalls(
                LogAwsCloudWatchConnectorConstants::AWS_LOG_STREAM_NAME_GLUE_DEFAULT_VALUE,
            );
    ...
    public function testGetAwsLogLevel(): void
    {
        $this->config->expects(static::atLeastOnce())
            ->method('get')
            ->withConsecutive(
                [LogAwsCloudWatchConnectorConstants::AWS_LOG_LEVEL_GLUE, LogAwsCloudWatchConnectorConstants::AWS_LOG_LEVEL_GLUE_DEFAULT_VALUE],
            )->willReturnOnConsecutiveCalls(
                LogAwsCloudWatchConnectorConstants::AWS_LOG_LEVEL_GLUE_DEFAULT_VALUE,
            );
