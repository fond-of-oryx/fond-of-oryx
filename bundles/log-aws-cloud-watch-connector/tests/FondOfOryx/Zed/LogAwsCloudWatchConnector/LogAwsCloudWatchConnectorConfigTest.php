...
class LogAwsCloudWatchConnectorConfigTest extends Unit
{
    ...
    public function testGetAwsLogGroupName(): void
    {
        $this->config->expects(static::atLeastOnce())
            ->method('get')
            ->withConsecutive(
                [LogAwsCloudWatchConnectorConstants::AWS_LOG_GROUP_NAME_ZED, LogAwsCloudWatchConnectorConstants::AWS_LOG_GROUP_NAME_ZED_DEFAULT_VALUE],
            )->willReturnOnConsecutiveCalls(
                LogAwsCloudWatchConnectorConstants::AWS_LOG_GROUP_NAME_ZED_DEFAULT_VALUE,
            );
    ...
    public function testGetAwsLogStreamName(): void
    {
        $this->config->expects(static::atLeastOnce())
            ->method('get')
            ->withConsecutive(
                [LogAwsCloudWatchConnectorConstants::AWS_LOG_STREAM_NAME_ZED, LogAwsCloudWatchConnectorConstants::AWS_LOG_STREAM_NAME_ZED_DEFAULT_VALUE],
            )->willReturnOnConsecutiveCalls(
                LogAwsCloudWatchConnectorConstants::AWS_LOG_STREAM_NAME_ZED_DEFAULT_VALUE,
            );
    ...
    public function testGetAwsLogLevel(): void
    {
        $this->config->expects(static::atLeastOnce())
            ->method('get')
            ->withConsecutive(
                [LogAwsCloudWatchConnectorConstants::AWS_LOG_LEVEL_ZED, LogAwsCloudWatchConnectorConstants::AWS_LOG_LEVEL_ZED_DEFAULT_VALUE],
            )->willReturnOnConsecutiveCalls(
                LogAwsCloudWatchConnectorConstants::AWS_LOG_LEVEL_ZED_DEFAULT_VALUE,
            );
