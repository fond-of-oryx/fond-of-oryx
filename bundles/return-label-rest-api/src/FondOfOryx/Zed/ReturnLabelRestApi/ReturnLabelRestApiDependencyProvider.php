...
use FondOfOryx\Zed\ReturnLabelRestApi\Dependency\ReturnLabelRestApiRestApiToCompanyAddressApiFacadeBridge;
...
class ReturnLabelRestApiDependencyProvider extends AbstractBundleDependencyProvider
{
    ...
    public function getCompanyUnitAddressApiFacade(Container $container): Container
    {
        $container->set(static::COMPANY_UNIT_ADDRESS_API_FACADE, static function (Container $container) {
            return new ReturnLabelRestApiRestApiToCompanyAddressApiFacadeBridge(
