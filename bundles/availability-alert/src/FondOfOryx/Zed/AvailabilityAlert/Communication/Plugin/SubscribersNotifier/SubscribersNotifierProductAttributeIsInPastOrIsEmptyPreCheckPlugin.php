 ...
 */
class SubscribersNotifierProductAttributeIsInPastOrIsEmptyPreCheckPlugin extends AbstractPlugin implements SubscribersNotifierPreCheckPluginInterface
{
    /**
    ...
    {
        return $this->getFacade()->preCheckSubscribersNotifierProductAttributeIsInPastOrIsEmpty($availabilityAlertSubscriptionTransfer);
    }
}
