...
use FondOfOryx\Zed\AvailabilityAlert\Communication\Plugin\SubscribersNotifier\SubscribersNotifierProductAttributeIsInPastOrIsEmptyPreCheckPlugin;
...
class AvailabilityAlertDependencyProvider extends AbstractBundleDependencyProvider
{
    ...
    protected function getSubscribersNotifierPreCheckPlugins(): array
    {
        return [
            ...
            new SubscribersNotifierProductAttributeIsInPastOrIsEmptyPreCheckPlugin(),
        ];
    }
