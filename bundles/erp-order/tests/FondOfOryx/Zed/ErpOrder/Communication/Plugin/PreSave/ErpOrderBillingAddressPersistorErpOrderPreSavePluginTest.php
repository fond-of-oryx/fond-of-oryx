...
class ErpOrderBillingAddressPersistorErpOrderPreSavePluginTest extends Unit
{
    /**
    ...
    protected function _before(): void
    {
        ...
        $this->plugin = new ErpOrderBillingAddressPersistorErpOrderPreSavePlugin();
    ...
    {
        $this->erpOrderFacadeMock->expects($this->once())->method('persistBillingAddress')->willReturn($this->erpOrderTransferMock);
