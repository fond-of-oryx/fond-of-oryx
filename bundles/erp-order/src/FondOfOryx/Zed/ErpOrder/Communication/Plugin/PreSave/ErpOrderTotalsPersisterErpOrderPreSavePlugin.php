 ...
 */
class ErpOrderTotalsPersisterErpOrderPreSavePlugin extends AbstractPlugin implements ErpOrderPreSavePluginInterface
{
    /**
    ...
    {
        return $this->getFacade()->persistErpOrderTotals($erpOrderTransfer);
    }
}
