 ...
 */
class ErpOrderItemPersistorErpOrderPostSavePlugin extends AbstractPlugin implements ErpOrderPostSavePluginInterface
{
    /**
    ...
    {
        return $this->getFacade()->persistErpOrderItem($erpOrderTransfer);
    }
}
