 ...
 * @codeCoverageIgnore
 *
 * @method \FondOfOryx\Zed\ErpOrderApi\Persistence\ErpOrderApiPersistenceFactory getFactory()
 */
class ErpOrderApiRepository extends AbstractRepository implements ErpOrderApiRepositoryInterface
{
    /**
