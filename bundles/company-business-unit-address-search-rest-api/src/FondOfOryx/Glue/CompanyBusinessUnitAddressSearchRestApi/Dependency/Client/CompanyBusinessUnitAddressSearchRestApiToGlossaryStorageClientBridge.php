...
class CompanyBusinessUnitAddressSearchRestApiToGlossaryStorageClientBridge implements CompanyBusinessUnitAddressSearchRestApiToGlossaryStorageClientInterface
{
    /**
