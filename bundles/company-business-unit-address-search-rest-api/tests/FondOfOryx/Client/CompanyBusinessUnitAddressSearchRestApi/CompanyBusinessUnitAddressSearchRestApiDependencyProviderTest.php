...
class CompanyBusinessUnitAddressSearchRestApiDependencyProviderTest extends Unit
{
    /**
    ...
    /**
     * @var \FondOfOryx\Client\CompanyBusinessUnitAddressSearchRestApi\CompanyBusinessUnitAddressSearchRestApiDependencyProvider
     */
    ...
    protected function _before(): void
    {
        ...
        $this->dependencyProvider = new CompanyBusinessUnitAddressSearchRestApiDependencyProvider();
    }
    ...
    public function testProvideServiceLayerDependencies(): void
    {
        ...
        static::assertInstanceOf(
            CompanyBusinessUnitAddressSearchRestApiToZedRequestClientInterface::class,
            $container[CompanyBusinessUnitAddressSearchRestApiDependencyProvider::CLIENT_ZED_REQUEST],
        );
    }
}
