 ...
 * @codeCoverageIgnore
 *
 * @method \FondOfOryx\Zed\CompanyUserApi\Persistence\CompanyUserApiPersistenceFactory getFactory()
 */
class CompanyUserApiRepository extends AbstractRepository implements CompanyUserApiRepositoryInterface
{
    /**
