...
class SplittableTotalsShipmentConnectorFacadeTest extends Unit
{
    /**
     * @var \FondOfOryx\Zed\SplittableTotalsShipmentConnector\Business\SplittableTotalsShipmentConnectorBusinessFactory|\PHPUnit\Framework\MockObject\MockObject
     */
    protected $businessFactoryMock;

    /**
     * @var \FondOfOryx\Zed\SplittableTotalsShipmentConnector\Business\Expander\SplittedQuoteExpanderInterface|\PHPUnit\Framework\MockObject\MockObject
     */
    ...
    /**
     * @var \FondOfOryx\Zed\SplittableTotalsShipmentConnector\Business\SplittableTotalsShipmentConnectorFacade
     */
    protected $facade;
    ...
    protected function _before(): void
    {
        ...
        $this->businessFactoryMock = $this->getMockBuilder(SplittableTotalsShipmentConnectorBusinessFactory::class)
        ...
        $this->facade = new SplittableTotalsShipmentConnectorFacade();
