 ...
 */
class ErpInvoiceExpensePersisterErpInvoicePostSavePlugin extends AbstractPlugin implements ErpInvoicePostSavePluginInterface
{
    /**
    ...
    {
        return $this->getFacade()->persistErpInvoiceExpense($erpInvoiceTransfer, $existingErpInvoiceTransfer);
    }
}
