...
class ErpInvoiceToCountryFacadeBridgeTest extends Unit
{
    /**
    ...
    /**
     * @var \FondOfOryx\Zed\ErpInvoice\Dependency\Facade\ErpInvoiceToCountryFacadeBridge
     */
    protected $facade;
    ...
    protected function _before()
    {
        ...
        $this->facade = new ErpInvoiceToCountryFacadeBridge($this->facadeMock);
    }
