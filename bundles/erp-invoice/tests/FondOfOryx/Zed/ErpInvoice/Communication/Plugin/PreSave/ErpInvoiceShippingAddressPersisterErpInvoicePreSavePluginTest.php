...
class ErpInvoiceShippingAddressPersisterErpInvoicePreSavePluginTest extends Unit
{
    /**
    ...
    protected function _before(): void
    {
        ...
        $this->plugin = new ErpInvoiceShippingAddressPersisterErpInvoicePreSavePlugin();
    ...
    {
        $this->erpInvoiceFacadeMock->expects($this->once())->method('persistShippingAddress')->willReturn($this->erpInvoiceTransferMock);
