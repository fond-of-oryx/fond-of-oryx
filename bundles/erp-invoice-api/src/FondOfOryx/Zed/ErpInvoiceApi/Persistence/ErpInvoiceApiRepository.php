 ...
 * @codeCoverageIgnore
 *
 * @method \FondOfOryx\Zed\ErpInvoiceApi\Persistence\ErpInvoiceApiPersistenceFactory getFactory()
 */
class ErpInvoiceApiRepository extends AbstractRepository implements ErpInvoiceApiRepositoryInterface
{
    /**
    ...
    protected function buildColumnSelection(): PropelQueryBuilderColumnSelectionTransfer
    {
        ...
        $tableColumns = FooErpInvoiceTableMap::getFieldNames(TableMap::TYPE_FIELDNAME);

        foreach ($tableColumns as $columnAlias) {
            $columnTransfer = (new PropelQueryBuilderColumnTransfer())
                ->setName(FooErpInvoiceTableMap::TABLE_NAME . '.' . $columnAlias)
