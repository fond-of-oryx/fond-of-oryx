 ...
 * @codeCoverageIgnore
 *
 * @method \FondOfOryx\Zed\ErpDeliveryNoteApi\Persistence\ErpDeliveryNoteApiPersistenceFactory getFactory()
 */
class ErpDeliveryNoteApiRepository extends AbstractRepository implements ErpDeliveryNoteApiRepositoryInterface
{
    /**
    ...
    protected function buildColumnSelection(): PropelQueryBuilderColumnSelectionTransfer
    {
        ...
        $tableColumns = FooErpDeliveryNoteTableMap::getFieldNames(TableMap::TYPE_FIELDNAME);

        foreach ($tableColumns as $columnAlias) {
            $columnTransfer = (new PropelQueryBuilderColumnTransfer())
                ->setName(FooErpDeliveryNoteTableMap::TABLE_NAME . '.' . $columnAlias)
