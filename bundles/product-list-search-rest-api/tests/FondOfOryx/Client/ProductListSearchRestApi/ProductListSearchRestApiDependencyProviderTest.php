...
class ProductListSearchRestApiDependencyProviderTest extends Unit
{
    ...
    /**
     * @var \FondOfOryx\Client\ProductListSearchRestApi\ProductListSearchRestApiDependencyProvider
     */
    ...
    public function testProvideServiceLayerDependencies(): void
    {
        ...
        static::assertInstanceOf(
            ProductListSearchRestApiToZedRequestClientInterface::class,
            $container[ProductListSearchRestApiDependencyProvider::CLIENT_ZED_REQUEST],
        );
    }
}
