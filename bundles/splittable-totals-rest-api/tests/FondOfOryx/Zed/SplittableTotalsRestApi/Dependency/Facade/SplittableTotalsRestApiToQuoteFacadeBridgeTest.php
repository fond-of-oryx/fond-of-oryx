...
class SplittableTotalsRestApiToQuoteFacadeBridgeTest extends Unit
{
    /**
    ...
    /**
     * @var \FondOfOryx\Zed\SplittableTotalsRestApi\Dependency\Facade\SplittableTotalsRestApiToQuoteFacadeBridge
     */
    protected $bridge;
    ...
    protected function _before(): void
    {
        ...
        $this->bridge = new SplittableTotalsRestApiToQuoteFacadeBridge(
