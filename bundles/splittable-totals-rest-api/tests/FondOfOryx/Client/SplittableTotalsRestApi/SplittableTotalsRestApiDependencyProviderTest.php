...
class SplittableTotalsRestApiDependencyProviderTest extends Unit
{
    ...
    /**
     * @var \FondOfOryx\Client\SplittableTotalsRestApi\SplittableTotalsRestApiDependencyProvider
     */
    ...
    public function testProvideServiceLayerDependencies(): void
    {
        ...
        static::assertInstanceOf(
            SplittableTotalsRestApiToZedRequestClientInterface::class,
            $container[SplittableTotalsRestApiDependencyProvider::CLIENT_ZED_REQUEST]
        );
    }
}
