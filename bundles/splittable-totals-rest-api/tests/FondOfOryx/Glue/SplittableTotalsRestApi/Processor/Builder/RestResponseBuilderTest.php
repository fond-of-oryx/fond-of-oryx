...
{
    /**
     * @var \FondOfOryx\Glue\SplittableTotalsRestApi\Processor\Mapper\RestSplittableTotalsMapperInterface|\PHPUnit\Framework\MockObject\MockObject
     */
    ...
    /**
     * @var \FondOfOryx\Glue\SplittableTotalsRestApi\Processor\Builder\RestResponseBuilder
     */
            ...
            ->with(
                static::callback(
                    static function (RestErrorMessageTransfer $restErrorMessageTransfer) {
                        return $restErrorMessageTransfer->getCode() === SplittableTotalsRestApiConfig::RESPONSE_CODE_SPLITTABLE_TOTALS_NOT_FOUND
                            && $restErrorMessageTransfer->getDetail() === SplittableTotalsRestApiConfig::EXCEPTION_MESSAGE_SPLITTABLE_TOTALS_NOT_FOUND
