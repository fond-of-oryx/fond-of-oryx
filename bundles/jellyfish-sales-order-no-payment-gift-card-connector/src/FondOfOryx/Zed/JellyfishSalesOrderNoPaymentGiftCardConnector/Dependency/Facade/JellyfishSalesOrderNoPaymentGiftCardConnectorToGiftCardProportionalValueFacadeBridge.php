...
class JellyfishSalesOrderNoPaymentGiftCardConnectorToGiftCardProportionalValueFacadeBridge implements JellyfishSalesOrderNoPaymentGiftCardConnectorToGiftCardProportionalValueFacadeInterface
{
    /**
