 ...
 */
class GiftCardRestrictionJellyfishOrderPostMapPlugin extends AbstractPlugin implements JellyfishOrderPostMapPluginInterface
{
    /**
    ...
    public function postMap(
        ...
        return $this->getFacade()->expandOrderItemsWithGiftCardRestrictionFlag($jellyfishOrderTransfer);
    }
}
