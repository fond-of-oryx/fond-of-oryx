...
namespace FondOfOryx\Client\BusinessOnBehalfRestApi\Dependency\Client;

use Spryker\Client\ZedRequest\ZedRequestClientInterface;
use Spryker\Shared\Kernel\Transfer\TransferInterface;

class BusinessOnBehalfRestApiToZedRequestClientBridge implements BusinessOnBehalfRestApiToZedRequestClientInterface
{
    /**
