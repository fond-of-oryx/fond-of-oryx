...
class CustomerRegistrationMailTypePlugin extends AbstractPlugin implements MailTypePluginInterface
{
    ...
    {
        $mailBuilder->setHtmlTemplate('company-user-mail-connector/mail/customer_registration.html.twig');
    ...
    {
        $mailBuilder->setTextTemplate('company-user-mail-connector/mail/customer_registration.text.twig');
