...
class RequestBuilderTest extends Unit
{
    ...
    public function testCreate(): void
    {
        ...
        $this->assertSame(ErpOrderPageSearchRestApiConfig::QUERY_STRING_PARAMETER, $transfer->getSearchString());
    ...
    public function testCreateWithPagination(): void
    {
        ...
        $this->assertIsArray($transfer->getFilters());
        $this->assertSame(ErpOrderPageSearchRestApiConfig::QUERY_STRING_PARAMETER, $transfer->getSearchString());
        $this->assertArrayHasKey(ErpOrderPageSearchRestApiConfig::PARAMETER_NAME_ITEMS_PER_PAGE, $transfer->getRequestParams());
        $this->assertArrayHasKey(ErpOrderPageSearchRestApiConfig::PARAMETER_NAME_PAGE, $transfer->getRequestParams());
        $this->assertEquals(1, $transfer->getRequestParams()[ErpOrderPageSearchRestApiConfig::PARAMETER_NAME_ITEMS_PER_PAGE]);
        $this->assertEquals(2, $transfer->getRequestParams()[ErpOrderPageSearchRestApiConfig::PARAMETER_NAME_PAGE]);
    }
}
