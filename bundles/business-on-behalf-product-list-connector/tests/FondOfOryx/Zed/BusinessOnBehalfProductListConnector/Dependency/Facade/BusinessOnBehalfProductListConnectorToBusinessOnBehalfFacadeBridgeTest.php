...
class BusinessOnBehalfProductListConnectorToBusinessOnBehalfFacadeBridgeTest extends Unit
{
    /**
    ...
    /**
     * @var \FondOfOryx\Zed\BusinessOnBehalfProductListConnector\Dependency\Facade\BusinessOnBehalfProductListConnectorToBusinessOnBehalfFacadeBridge
     */
    protected BusinessOnBehalfProductListConnectorToBusinessOnBehalfFacadeBridge $bridge;
    ...
    protected function _before(): void
    {
        ...
        $this->bridge = new BusinessOnBehalfProductListConnectorToBusinessOnBehalfFacadeBridge(
            $this->facadeMock,
        );
    }
