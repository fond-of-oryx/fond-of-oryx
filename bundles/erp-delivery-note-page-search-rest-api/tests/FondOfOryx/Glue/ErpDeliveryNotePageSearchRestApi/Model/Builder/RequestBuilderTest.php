...
class RequestBuilderTest extends Unit
{
    ...
    public function testCreate(): void
    {
        ...
        $this->parameterBagMock->expects($this->once())->method('get')->willReturn(ErpDeliveryNotePageSearchRestApiConfig::QUERY_STRING_PARAMETER);
        ...
        $this->assertSame(ErpDeliveryNotePageSearchRestApiConfig::QUERY_STRING_PARAMETER, $transfer->getSearchString());
    ...
    public function testCreateWithPagination(): void
    {
        ...
        $this->assertIsArray($transfer->getFilters());
        $this->assertSame(ErpDeliveryNotePageSearchRestApiConfig::QUERY_STRING_PARAMETER, $transfer->getSearchString());
        $this->assertArrayHasKey(ErpDeliveryNotePageSearchRestApiConfig::PARAMETER_NAME_ITEMS_PER_PAGE, $transfer->getRequestParams());
        $this->assertArrayHasKey(ErpDeliveryNotePageSearchRestApiConfig::PARAMETER_NAME_PAGE, $transfer->getRequestParams());
        $this->assertEquals(1, $transfer->getRequestParams()[ErpDeliveryNotePageSearchRestApiConfig::PARAMETER_NAME_ITEMS_PER_PAGE]);
        $this->assertEquals(2, $transfer->getRequestParams()[ErpDeliveryNotePageSearchRestApiConfig::PARAMETER_NAME_PAGE]);
    }
}
