...
class ModelKeySearchExpanderPluginTest extends Unit
{
    ...
    /**
     * @var \FondOfOryx\Client\ProductStyleSearchExpander\Plugin\Elasticsearch\QueryExpander\ModelKeySearchQueryExpanderPlugin
     */
    ...
    protected function _before()
    {
        ...
        $this->queryExpanderPlugin = new ModelKeySearchQueryExpanderPlugin();
    ...
    public function testExpandQuerySuccess()
    {
        ...
        $this->queryExpanderPlugin->expandQuery($this->searchQueryMock, ['model_key' => 'model_key']);
    }

    /**
     * @return void
     */
    public function testExpandQueryFailedModelKeyNoSet()
    {
        $this->searchQueryMock->expects($this->never())
            ->method('getSearchQuery')
            ->willReturn($this->elasticaQueryMock);

        $this->queryExpanderPlugin->expandQuery($this->searchQueryMock, ['wrong_key' => 'wrong_key']);
    }
}
