...
class ThirtyFiveUpApiRepositoryTest extends Unit
{
    ...
    public function testFind(): void
    {
        ...
        $this->factoryMock->expects($this->once())->method('getQueryContainer')->willReturn($this->thirtyFiveUpQueryContainerMock);
        ...
        $this->thirtyFiveUpQueryContainerMock->expects($this->once())->method('createApiCollection')->willReturn($this->apiCollectionTransferMock);
    ...
    public function testConvertThrowsException(): void
    {
        ...
        $this->factoryMock->expects($this->never())->method('getQueryContainer')->willReturn($this->thirtyFiveUpQueryContainerMock);
        $this->thirtyFiveUpQueryContainerMock->expects($this->never())->method('createApiItem')->willReturn($this->apiItemTransferMock);
