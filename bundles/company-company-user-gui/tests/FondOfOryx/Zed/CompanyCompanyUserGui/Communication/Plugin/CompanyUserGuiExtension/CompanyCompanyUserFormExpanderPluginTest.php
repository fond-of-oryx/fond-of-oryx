...
class CompanyCompanyUserFormExpanderPluginTest extends Unit
{
    /**
    ...
    /**
     * @var \FondOfOryx\Zed\CompanyCompanyUserGui\Communication\Plugin\CompanyUserGuiExtension\CompanyCompanyUserFormExpanderPlugin
     */
    protected $plugin;
    ...
    protected function _before(): void
    {
        ...
        $this->plugin = new CompanyCompanyUserFormExpanderPlugin();
