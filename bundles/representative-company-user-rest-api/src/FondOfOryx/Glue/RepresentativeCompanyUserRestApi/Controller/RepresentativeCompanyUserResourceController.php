...
class RepresentativeCompanyUserResourceController extends AbstractController
{
    ...
    {
        return $this->getFactory()->createRepresentationManager()->get($restRequest);
    }
    ...
    {
        return $this->getFactory()->createRepresentationManager()->patch($restRequest);
    }
    ...
    {
        return $this->getFactory()->createRepresentationManager()->delete($restRequest);
    }
}
