 ...
 * @method     ChildSpyTouchStorage[]|Collection findByIdTouchStorage(int $id_touch_storage) Return ChildSpyTouchStorage objects filtered by the id_touch_storage column
 * @psalm-method Collection&\Traversable<ChildSpyTouchStorage> findByIdTouchStorage(int $id_touch_storage) Return ChildSpyTouchStorage objects filtered by the id_touch_storage column
 * @method     ChildSpyTouchStorage[]|Collection findByFkLocale(int $fk_locale) Return ChildSpyTouchStorage objects filtered by the fk_locale column
 * @psalm-method Collection&\Traversable<ChildSpyTouchStorage> findByFkLocale(int $fk_locale) Return ChildSpyTouchStorage objects filtered by the fk_locale column
 * @method     ChildSpyTouchStorage[]|Collection findByFkStore(int $fk_store) Return ChildSpyTouchStorage objects filtered by the fk_store column
 * @psalm-method Collection&\Traversable<ChildSpyTouchStorage> findByFkStore(int $fk_store) Return ChildSpyTouchStorage objects filtered by the fk_store column
 * @method     ChildSpyTouchStorage[]|Collection findByFkTouch(int $fk_touch) Return ChildSpyTouchStorage objects filtered by the fk_touch column
 * @psalm-method Collection&\Traversable<ChildSpyTouchStorage> findByFkTouch(int $fk_touch) Return ChildSpyTouchStorage objects filtered by the fk_touch column
 * @method     ChildSpyTouchStorage[]|Collection findByKey(string $key) Return ChildSpyTouchStorage objects filtered by the key column
 * @psalm-method Collection&\Traversable<ChildSpyTouchStorage> findByKey(string $key) Return ChildSpyTouchStorage objects filtered by the key column
