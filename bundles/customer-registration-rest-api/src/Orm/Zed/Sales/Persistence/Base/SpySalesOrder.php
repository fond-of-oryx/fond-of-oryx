 ...
 *
 *
 * @package    propel.generator.Orm.Zed.Sales.Persistence.Base
 */
abstract class SpySalesOrder implements ActiveRecordInterface
{
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : SpySalesOrderTableMap::translateFieldName('CustomerReference', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 1; // 1 = SpySalesOrderTableMap::NUM_HYDRATE_COLUMNS.
    ...
    public function toArray(string $keyType = TableMap::TYPE_PHPNAME, bool $includeLazyLoadColumns = true, array $alreadyDumpedObjects = []): array
    {
        ...
        $result = [
            $keys[0] => $this->getCustomerReference(),
        ];
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setCustomerReference($arr[$keys[0]]);
        }
