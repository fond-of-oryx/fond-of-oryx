 ...
 */
class SpyTouchStorageEntityTransfer extends AbstractEntityTransfer
{
    /**
     * @var string
     */
    public const ID_TOUCH_STORAGE = 'idTouchStorage';
    ...
    protected $transferPropertyNameMap = [
        'id_touch_storage' => 'idTouchStorage',
        'idTouchStorage' => 'idTouchStorage',
        'IdTouchStorage' => 'idTouchStorage',
        'fk_locale' => 'fkLocale',
        'fkLocale' => 'fkLocale',
        'FkLocale' => 'fkLocale',
    ...
    protected $transferMetadata = [
        self::ID_TOUCH_STORAGE => [
            'type' => 'integer',
            'type_shim' => null,
            'name_underscore' => 'id_touch_storage',
            'is_collection' => false,
            'is_transfer' => false,
     ...
     * @var string
     */
    public static $entityNamespace = 'Orm\Zed\Touch\Persistence\SpyTouchStorage';


    /**
     * @module 
     *
     * @param integer|null $idTouchStorage
     *
     * @return $this
     */
    public function setIdTouchStorage($idTouchStorage)
    {
        $this->idTouchStorage = $idTouchStorage;
        $this->modifiedProperties[self::ID_TOUCH_STORAGE] = true;
     ...
     * @return $this
     */
    public function setIdTouchStorageOrFail($idTouchStorage)
    {
        if ($idTouchStorage === null) {
            $this->throwNullValueException(static::ID_TOUCH_STORAGE);
        }

        return $this->setIdTouchStorage($idTouchStorage);
    }
     ...
     * @return integer
     */
    public function getIdTouchStorageOrFail()
    {
        if ($this->idTouchStorage === null) {
            $this->throwNullValueException(static::ID_TOUCH_STORAGE);
        }
     ...
     * @return $this
     */
    public function requireIdTouchStorage()
    {
        $this->assertPropertyIsSet(self::ID_TOUCH_STORAGE);
    ...
    {
        return [
            'idTouchStorage' => $this->idTouchStorage,
    ...
    {
        return [
            'id_touch_storage' => $this->idTouchStorage,
    ...
    {
        return [
            'id_touch_storage' => $this->idTouchStorage instanceof AbstractTransfer ? $this->idTouchStorage->toArray(true, false) : $this->idTouchStorage,
    ...
    {
        return [
            'idTouchStorage' => $this->idTouchStorage instanceof AbstractTransfer ? $this->idTouchStorage->toArray(true, true) : $this->idTouchStorage,
