...
class SplittableCheckoutResourceRoutePluginTest extends Unit
{
    /**
    ...
    /**
     * @var \FondOfOryx\Glue\SplittableCheckoutRestApi\Plugin\GlueApplicationExtension\SplittableCheckoutResourceRoutePlugin
     */
    protected $plugin;
    ...
    protected function _before(): void
    {
        ...
        $this->plugin = new SplittableCheckoutResourceRoutePlugin();
    }
