...
class CompanyFilterFieldsExpanderPluginTest extends Unit
{
    ...
    /**
     * @var \FondOfOryx\Glue\CompanyBrandsRestApi\Plugin\BrandsRestApiExtension\CompanyFilterFieldsExpanderPlugin
     */
    protected $plugin;
    ...
    public function testExpand(): void
    {
        ...
        $this->httpRequestMock->query = new InputBag(
            [
                CompanyBrandsRestApiConfig::PARAMETER_NAME_COMPANY_ID => $companyUuid,
            ],
        );
        ...
        static::assertEquals(CompanyBrandsRestApiConstants::FILTER_FIELD_TYPE_COMPANY_UUID, $filterFieldTransfer->getType());
