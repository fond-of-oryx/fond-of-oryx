...
class CustomerFilterFieldsExpanderPluginTest extends Unit
{
    ...
    /**
     * @var \FondOfOryx\Glue\CompanyBrandsRestApi\Plugin\BrandsRestApiExtension\CustomerFilterFieldsExpanderPlugin
     */
    protected $plugin;
    ...
    public function testExpand(): void
    {
        ...
        static::assertEquals(CompanyBrandsRestApiConstants::FILTER_FIELD_TYPE_ID_CUSTOMER, $filterFieldTransfer->getType());
