 ...
 * @codeCoverageIgnore
 *
 * @method \FondOfOryx\Zed\ConcreteProductApi\Persistence\ConcreteProductApiPersistenceFactory getFactory()
 */
class ConcreteProductApiRepository extends AbstractRepository implements ConcreteProductApiRepositoryInterface
{
    /**
