...
class ProductCountryRestrictionCheckoutConnectorToZedRequestClientBridge implements
    ProductCountryRestrictionCheckoutConnectorToZedRequestClientInterface
{
    /**
