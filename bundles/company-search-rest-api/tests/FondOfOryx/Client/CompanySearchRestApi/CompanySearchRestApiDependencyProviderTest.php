...
class CompanySearchRestApiDependencyProviderTest extends Unit
{
    /**
    ...
    /**
     * @var \FondOfOryx\Client\CompanySearchRestApi\CompanySearchRestApiDependencyProvider
     */
    ...
    protected function _before(): void
    {
        ...
        $this->dependencyProvider = new CompanySearchRestApiDependencyProvider();
    }
    ...
    public function testProvideServiceLayerDependencies(): void
    {
        ...
        static::assertInstanceOf(
            CompanySearchRestApiToZedRequestClientInterface::class,
            $container[CompanySearchRestApiDependencyProvider::CLIENT_ZED_REQUEST]
        );
    }
}
