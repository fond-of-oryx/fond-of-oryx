...
namespace FondOfOryx\Client\CompanySearchRestApi\Dependency\Client;

use Codeception\Test\Unit;
use Spryker\Client\ZedRequest\ZedRequestClientInterface;
use Spryker\Shared\Kernel\Transfer\TransferInterface;

class CompanySearchRestApiToZedRequestClientBridgeTest extends Unit
{
    /**
    ...
    /**
     * @var \FondOfOryx\Client\CompanySearchRestApi\Dependency\Client\CompanySearchRestApiToZedRequestClientBridge
     */
    ...
    protected function _before(): void
    {
        ...
        $this->zedRequestClientBridge = new CompanySearchRestApiToZedRequestClientBridge(
