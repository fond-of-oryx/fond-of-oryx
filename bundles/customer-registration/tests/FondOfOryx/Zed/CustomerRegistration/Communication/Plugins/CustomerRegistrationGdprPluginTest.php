...
class CustomerRegistrationGdprPluginTest extends Unit
{
    /**
    ...
    protected function _before(): void
    {
        ...
        $this->plugin = new CustomerRegistrationGdprPlugin();
    ...
    {
        $this->facadeMock->expects(static::atLeastOnce())->method('checkGdpr')->willReturn($this->customerRegistrationRequestTransferMock);
