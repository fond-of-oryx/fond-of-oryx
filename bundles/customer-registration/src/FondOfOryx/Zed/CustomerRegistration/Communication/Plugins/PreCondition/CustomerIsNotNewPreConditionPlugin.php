...
class CustomerIsNotNewPreConditionPlugin implements CustomerRegistrationPreStepConditionPluginInterface
{
    /**
    ...
    {
        return $customerRegistrationRequestTransfer->getBagOrFail()->getCustomer()->getIsNew() !== true;
    }
}
