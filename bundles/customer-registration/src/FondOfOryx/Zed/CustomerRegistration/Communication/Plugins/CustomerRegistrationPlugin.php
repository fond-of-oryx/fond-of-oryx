 ...
 */
class CustomerRegistrationPlugin extends AbstractPlugin implements CustomerRegistrationPluginInterface
{
    /**
    ...
    {
        return $this->getFacade()->registerCustomer($customerRegistrationRequestTransfer);
    }
}
