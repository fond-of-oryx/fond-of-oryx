...
class EmailAddressVerificationIsRequestedPreConditionPlugin implements CustomerRegistrationPreStepConditionPluginInterface
{
    /**
    ...
    {
        return $customerRegistrationRequestTransfer->getAttributesOrFail()->getVerifyEmail() === true;
    }
}
