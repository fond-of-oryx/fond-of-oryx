 ...
 */
class CustomerRegistrationEmailVerificationPlugin extends AbstractPlugin implements CustomerRegistrationPluginInterface
{
    /**
    ...
    {
        return $this->getFacade()->verifyMail($customerRegistrationRequestTransfer);
    }
}
