...
/**
 * @deprecated Use {@link \FondOfOryx\Zed\CustomerRegistration\Communication\Plugins\Mail\CustomerRegistrationConfirmationMailjetMailTypeBuilder} instead
 */
class CustomerRegistrationConfirmationMailTypeBuilder extends AbstractPlugin implements MailTypePluginInterface
{
    /**
     * @var string
     */
