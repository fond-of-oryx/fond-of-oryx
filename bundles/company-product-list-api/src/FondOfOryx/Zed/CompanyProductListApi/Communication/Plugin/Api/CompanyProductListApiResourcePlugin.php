...
/**
 * @method \FondOfOryx\Zed\CompanyProductListApi\Business\CompanyProductListApiFacadeInterface getFacade()
 */
class CompanyProductListApiResourcePlugin extends AbstractPlugin implements ApiResourcePluginInterface
{
    /**
     * @param int $idCompany
     *
     ...
     */
    public function get($idCompany): ApiItemTransfer
    {
     ...
     * @return \Generated\Shared\Transfer\ApiItemTransfer
     */
    public function update($idCompany, ApiDataTransfer $apiDataTransfer)
    {
    ...
    {
        return $this->getFacade()->addCompanyProductList($apiDataTransfer);
    }
     ...
     * @return \Generated\Shared\Transfer\ApiItemTransfer
     */
    public function remove($idCompany): ApiItemTransfer
    {
    ...
    {
        return CompanyProductListApiConfig::RESOURCE_COMPANY_PRODUCT_LIST;
    }
}
