...
class CompanyUserSearchRestApiDependencyProviderTest extends Unit
{
    /**
    ...
    /**
     * @var \FondOfOryx\Client\CompanyUserSearchRestApi\CompanyUserSearchRestApiDependencyProvider
     */
    ...
    protected function _before(): void
    {
        ...
        $this->dependencyProvider = new CompanyUserSearchRestApiDependencyProvider();
    }
    ...
    public function testProvideServiceLayerDependencies(): void
    {
        ...
        static::assertInstanceOf(
            CompanyUserSearchRestApiToZedRequestClientInterface::class,
            $container[CompanyUserSearchRestApiDependencyProvider::CLIENT_ZED_REQUEST],
        );
    }
}
