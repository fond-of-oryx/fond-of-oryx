...
namespace FondOfOryx\Client\CompanyUserSearchRestApi\Dependency\Client;

use Codeception\Test\Unit;
use Spryker\Client\ZedRequest\ZedRequestClientInterface;
use Spryker\Shared\Kernel\Transfer\TransferInterface;

class CompanyUserSearchRestApiToZedRequestClientBridgeTest extends Unit
{
    /**
    ...
    protected function _before(): void
    {
        ...
        $this->zedRequestClientBridge = new CompanyUserSearchRestApiToZedRequestClientBridge(
