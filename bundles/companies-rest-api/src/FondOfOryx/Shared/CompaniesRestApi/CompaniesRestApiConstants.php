...
namespace FondOfOryx\Shared\CompaniesRestApi;

interface CompaniesRestApiConstants
{
    /**
     * @var string
     */
     ...
     * @var string
     */
    public const FULLTEXT_SEARCH_FIELDS = 'FOND_OF_ORYX:COMPANIES_REST_API:FULLTEXT_SEARCH_FIELDS';
     ...
     * @var string
     */
    public const USE_WHITELIST_PERMISSIONS = 'FOND_OF_ORYX:COMPANIES_REST_API:USE_WHITELIST_PERMISSIONS';
     ...
     * @var string
     */
    public const WHITELIST_PERMISSION_PREFIX = 'FOND_OF_ORYX:COMPANIES_REST_API:WHITELIST_PERMISSION_PREFIX';
     ...
     * @var string
     */
    public const WHITELIST_PERMISSION_SUFFIX = 'FOND_OF_ORYX:COMPANIES_REST_API:WHITELIST_PERMISSION_SUFFIX';
