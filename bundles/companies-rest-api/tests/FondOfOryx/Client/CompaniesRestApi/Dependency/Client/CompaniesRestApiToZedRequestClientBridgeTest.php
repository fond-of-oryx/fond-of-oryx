...
class CompaniesRestApiToZedRequestClientBridgeTest extends Unit
{
    ...
    /**
     * @var \FondOfOryx\Client\CompaniesRestApi\Dependency\Client\CompaniesRestApiToZedRequestClientBridge
     */
    ...
    protected function _before(): void
    {
        ...
        $this->zedRequestClientBridge = new CompaniesRestApiToZedRequestClientBridge(
