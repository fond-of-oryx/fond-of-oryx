...
class ErpOrderPageSearchOwnParamFilterQueryExpanderPluginTest extends Unit
{
    ...
    public function testExpandQuery(): void
    {
        ...
        $this->erpOrderPageSearchFactoryMock->expects(static::any())
            ->method('getCustomerClient')
            ->willReturn($this->erpOrderPageSearchToCustomerClientMock);

        $this->erpOrderPageSearchToCustomerClientMock->expects(static::any())
            ->method('getCustomer')
        ...
        $this->erpOrderPageSearchToCompanyUserClientMock->expects(static::any())
