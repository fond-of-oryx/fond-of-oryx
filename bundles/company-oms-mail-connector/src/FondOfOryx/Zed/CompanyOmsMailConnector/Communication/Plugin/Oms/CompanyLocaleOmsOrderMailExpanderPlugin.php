 ...
 */
class CompanyLocaleOmsOrderMailExpanderPlugin extends AbstractPlugin implements OmsOrderMailExpanderPluginInterface
{
    /**
     * Specification:
    ...
    {
        return $this->getFacade()->expandOrderMailTransferWithCompanyLocale($mailTransfer, $orderTransfer);
    }
}
