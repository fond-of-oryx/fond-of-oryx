...
class JellyfishSalesOrderPayoneGiftCardConnectorToGiftCardProportionalValueFacadeBridge implements JellyfishSalesOrderPayoneGiftCardConnectorToGiftCardProportionalValueFacadeInterface
{
    /**
