 ...
 * @codeCoverageIgnore
 *
 * @method \FondOfOryx\Zed\CustomerApi\Persistence\CustomerApiPersistenceFactory getFactory()
 */
class CustomerApiRepository extends AbstractRepository implements CustomerApiRepositoryInterface
{
    /**
    ...
    protected function buildColumnSelection(): PropelQueryBuilderColumnSelectionTransfer
    {
        ...
        foreach ($tableColumns as $columnAlias) {
            $columnTransfer = (new PropelQueryBuilderColumnTransfer())
                ->setName(SpyCustomerTableMap::TABLE_NAME . '.' . $columnAlias)
