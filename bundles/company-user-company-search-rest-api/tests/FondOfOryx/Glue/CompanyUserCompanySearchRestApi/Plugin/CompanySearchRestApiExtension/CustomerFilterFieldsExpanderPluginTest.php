...
class CustomerFilterFieldsExpanderPluginTest extends Unit
{
    ...
    /**
     * @var \ArrayObject<(\Generated\Shared\Transfer\FilterFieldTransfer&\PHPUnit\Framework\MockObject\MockObject)|\PHPUnit\Framework\MockObject\MockObject>
     */
    protected ArrayObject $filterFieldTransfers;

    /**
     * @var \FondOfOryx\Glue\CompanyUserCompanySearchRestApi\Plugin\CompanySearchRestApiExtension\CustomerFilterFieldsExpanderPlugin
     */
    ...
    public function testExpand(): void
    {
        ...
        static::assertEquals(CompanyUserCompanySearchRestApiConstants::FILTER_FIELD_TYPE_ID_CUSTOMER, $filterFieldTransfer->getType());
