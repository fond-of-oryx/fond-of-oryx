...
namespace FondOfOryx\Client\CompanyRoleSearchRestApi\Dependency\Client;

use Codeception\Test\Unit;
use Spryker\Client\ZedRequest\ZedRequestClientInterface;
use Spryker\Shared\Kernel\Transfer\TransferInterface;

class CompanyRoleSearchRestApiToZedRequestClientBridgeTest extends Unit
{
    /**
    ...
    protected function _before(): void
    {
        ...
        $this->zedRequestClientBridge = new CompanyRoleSearchRestApiToZedRequestClientBridge(
