...
class GiftCardProductConnectorProductAbstractAfterCreatePluginTest extends Unit
{
    /**
    ...
    /**
     * @var \FondOfOryx\Zed\GiftCardProductConnector\Communication\Plugin\Product\GiftCardProductConnectorProductAbstractAfterCreatePlugin
     */
    protected $plugin;
    ...
    public function _before()
    {
        ...
        $this->plugin = new GiftCardProductConnectorProductAbstractAfterCreatePlugin();
    ...
    public function testCreate(): void
    {
        ...
        $productAbstractTransfer = $this->plugin->create($this->productAbstractTransferMock);
