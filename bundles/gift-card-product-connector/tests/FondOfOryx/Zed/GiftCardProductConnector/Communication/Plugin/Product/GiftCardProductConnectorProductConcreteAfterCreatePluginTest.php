...
class GiftCardProductConnectorProductConcreteAfterCreatePluginTest extends Unit
{
    /**
    ...
    /**
     * @var \FondOfOryx\Zed\GiftCardProductConnector\Communication\Plugin\Product\GiftCardProductConnectorProductConcreteAfterCreatePlugin
     */
    protected $plugin;
    ...
    public function _before()
    {
        ...
        $this->plugin = new GiftCardProductConnectorProductConcreteAfterCreatePlugin();
    ...
    public function testCreate(): void
    {
        ...
        $productConcreteTransfer = $this->plugin->create($this->productConcreteTransferMock);
