...
class TypeExpanderPluginTest extends Unit
{
    /**
    ...
    /**
     * @var \FondOfOryx\Glue\DocumentsRestApi\Processor\Expander\TypeExpanderPlugin
     */
    protected TypeExpanderPlugin $expanderPlugin;
    ...
    protected function _before(): void
    {
        ...
        $this->expanderPlugin = new TypeExpanderPlugin();
    }
