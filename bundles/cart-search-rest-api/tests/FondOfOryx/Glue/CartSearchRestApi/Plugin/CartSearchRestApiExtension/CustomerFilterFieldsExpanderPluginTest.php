...
class CustomerFilterFieldsExpanderPluginTest extends Unit
{
    ...
    /**
     * @var \FondOfOryx\Glue\CartSearchRestApi\Plugin\CartSearchRestApiExtension\CustomerFilterFieldsExpanderPlugin
     */
    protected $plugin;
    ...
    public function testExpand(): void
    {
        ...
        static::assertEquals(CartSearchRestApiConstants::FILTER_FIELD_TYPE_ID_CUSTOMER, $filterFieldTransfer->getType());
