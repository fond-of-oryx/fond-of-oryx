...
class CartSearchRestApiToGlossaryStorageClientBridgeTest extends Unit
{
    /**
    ...
    protected function _before(): void
    {
        ...
        $this->bridge = new CartSearchRestApiToGlossaryStorageClientBridge($this->glossaryStorageClientMock);
    }
