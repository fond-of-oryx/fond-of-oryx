...
namespace FondOfOryx\Zed\RepresentativeCompanyUserRestApiPermission;

use Orm\Zed\CompanyRole\Persistence\SpyCompanyRoleToPermissionQuery;
use Spryker\Zed\Kernel\AbstractBundleDependencyProvider;
use Spryker\Zed\Kernel\Container;

class RepresentativeCompanyUserRestApiPermissionDependencyProvider extends AbstractBundleDependencyProvider
{
    /**
     * @var string
     */
