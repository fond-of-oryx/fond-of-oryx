...
class ProductListsRestApiDependencyProviderTest extends Unit
{
    ...
    /**
     * @var \FondOfOryx\Client\ProductListsRestApi\ProductListsRestApiDependencyProvider
     */
    ...
    protected function _before(): void
    {
        ...
        $this->dependencyProvider = new ProductListsRestApiDependencyProvider();
    }
    ...
    public function testProvideServiceLayerDependencies(): void
    {
        ...
        static::assertInstanceOf(
            ProductListsRestApiToZedRequestClientInterface::class,
            $container[ProductListsRestApiDependencyProvider::CLIENT_ZED_REQUEST],
        );
    }
}
