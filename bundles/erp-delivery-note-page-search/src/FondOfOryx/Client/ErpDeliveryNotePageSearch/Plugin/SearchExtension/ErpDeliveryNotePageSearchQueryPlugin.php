...
class ErpDeliveryNotePageSearchQueryPlugin extends AbstractPlugin implements QueryInterface, SearchContextAwareQueryInterface, SearchStringSetterInterface, SearchStringGetterInterface
{
    /**
     * @var string
     */
    protected const SOURCE_IDENTIFIER = 'erp-delivery-note';
    ...
    protected function createSearchQuery(): Query
    {
        ...
        return (new Query())
            ->setQuery($boolQuery)
            ->setSource([ErpDeliveryNoteIndexMap::SEARCH_RESULT_DATA]);
    }
