...
class ErpDeliveryNoteDeletePublisherPluginTest extends Unit
{
    ...
    protected ErpDeliveryNoteDeletePublisherPlugin $plugin;
    ...
    protected function _before(): void
    {
        ...
        $this->plugin = new ErpDeliveryNoteDeletePublisherPlugin();
