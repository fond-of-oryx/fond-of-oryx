...
class ExternalReferenceErpDeliveryNotePageSearchQueryExpanderPluginTest extends Unit
{
    /**
    ...
    /**
     * @var \FondOfOryx\Client\ErpDeliveryNotePageSearch\Plugin\SearchExtension\ExternalReferenceErpDeliveryNotePageSearchQueryExpanderPlugin
     */
    protected $plugin;
    ...
    protected function _before(): void
    {
        ...
        $this->requestParameters = [
            ErpDeliveryNotePageSearchConstants::PARAMETER_EXTERNAL_REFERENCE => [
                'EXTERNAL-FOO-BAR-1',
            ],
        ];

        $this->plugin = new ExternalReferenceErpDeliveryNotePageSearchQueryExpanderPlugin();
    }
            ...
            ->with(
                static::callback(
                    static function (Terms $terms) use ($self) {
                        ...
                        return isset($data['terms'][ErpDeliveryNoteIndexMap::EXTERNAL_REFERENCE])
                            && $data['terms'][ErpDeliveryNoteIndexMap::EXTERNAL_REFERENCE] === $self->requestParameters[ErpDeliveryNotePageSearchConstants::PARAMETER_EXTERNAL_REFERENCE];
                    },
                ),
            )->willReturn($this->boolQueryMock);
