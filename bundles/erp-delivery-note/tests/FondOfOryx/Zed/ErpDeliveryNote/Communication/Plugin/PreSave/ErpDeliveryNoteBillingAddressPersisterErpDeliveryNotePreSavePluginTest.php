...
class ErpDeliveryNoteBillingAddressPersisterErpDeliveryNotePreSavePluginTest extends Unit
{
    /**
    ...
    protected function _before(): void
    {
        ...
        $this->plugin = new ErpDeliveryNoteBillingAddressPersisterErpDeliveryNotePreSavePlugin();
    ...
    {
        $this->erpDeliveryNoteFacadeMock->expects($this->once())->method('persistBillingAddress')->willReturn($this->erpDeliveryNoteTransferMock);
