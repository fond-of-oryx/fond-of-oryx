...
class ErpDeliveryNoteExpensePersisterErpDeliveryNotePostSavePluginTest extends Unit
{
    /**
    ...
    protected function _before(): void
    {
        ...
        $this->plugin = new ErpDeliveryNoteExpensePersisterErpDeliveryNotePostSavePlugin();
    ...
    {
        $this->erpDeliveryNoteFacadeMock->expects($this->once())->method('persistErpDeliveryNoteExpense')->willReturn($this->erpDeliveryNoteTransferMock);
