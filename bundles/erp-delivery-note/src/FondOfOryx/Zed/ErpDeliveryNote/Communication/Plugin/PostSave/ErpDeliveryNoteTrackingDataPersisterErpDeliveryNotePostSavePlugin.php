 ...
 */
class ErpDeliveryNoteTrackingDataPersisterErpDeliveryNotePostSavePlugin extends AbstractPlugin implements ErpDeliveryNotePostSavePluginInterface
{
    /**
    ...
    public function postSave(
        ...
        return $this->getFacade()->persistErpDeliveryNoteTrackingData($erpDeliveryNoteTransfer, $existingErpDeliveryNoteTransfer);
    }
}
