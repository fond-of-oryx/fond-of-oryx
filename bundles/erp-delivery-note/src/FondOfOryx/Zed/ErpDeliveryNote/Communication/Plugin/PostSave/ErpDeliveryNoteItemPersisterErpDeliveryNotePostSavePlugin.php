 ...
 */
class ErpDeliveryNoteItemPersisterErpDeliveryNotePostSavePlugin extends AbstractPlugin implements ErpDeliveryNotePostSavePluginInterface
{
    /**
    ...
    public function postSave(
        ...
        return $this->getFacade()->persistErpDeliveryNoteItem($erpDeliveryNoteTransfer, $existingErpDeliveryNoteTransfer);
    }
}
