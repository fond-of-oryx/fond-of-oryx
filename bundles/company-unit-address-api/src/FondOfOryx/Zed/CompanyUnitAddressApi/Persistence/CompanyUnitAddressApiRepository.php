 ...
 * @codeCoverageIgnore
 *
 * @method \FondOfOryx\Zed\CompanyUnitAddressApi\Persistence\CompanyUnitAddressApiPersistenceFactory getFactory()
 */
class CompanyUnitAddressApiRepository extends AbstractRepository implements CompanyUnitAddressApiRepositoryInterface
{
    /**
