...
class ErpInvoicePageSearchQueryPlugin extends AbstractPlugin implements QueryInterface, SearchContextAwareQueryInterface, SearchStringSetterInterface, SearchStringGetterInterface
{
    /**
     * @var string
     */
    protected const SOURCE_IDENTIFIER = 'erp-invoice';
    ...
    protected function createSearchQuery(): Query
    {
        ...
        return (new Query())
            ->setQuery($boolQuery)
            ->setSource([ErpInvoiceIndexMap::SEARCH_RESULT_DATA]);
    }
    ...
    protected function createFulltextSearchQuery(): AbstractQuery
    {
        ...
        return (new MultiMatch())->setQuery($this->searchString)
            ->setFields([
                ErpInvoiceIndexMap::FULL_TEXT,
                sprintf('%s^3', ErpInvoiceIndexMap::FULL_TEXT_BOOSTED),
