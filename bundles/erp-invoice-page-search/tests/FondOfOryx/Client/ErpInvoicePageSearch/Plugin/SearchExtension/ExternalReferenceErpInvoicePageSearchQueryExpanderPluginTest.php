...
class ExternalReferenceErpInvoicePageSearchQueryExpanderPluginTest extends Unit
{
    /**
    ...
    protected function _before(): void
    {
        ...
        $this->requestParameters = [
            ErpInvoicePageSearchConstants::PARAMETER_EXTERNAL_REFERENCE => [
                'EXTERNAL-FOO-BAR-1',
            ],
        ];

        $this->plugin = new ExternalReferenceErpInvoicePageSearchQueryExpanderPlugin();
    }
            ...
            ->with(
                static::callback(
                    static function (Terms $terms) use ($self) {
                        ...
                        return isset($data['terms'][ErpInvoiceIndexMap::EXTERNAL_REFERENCE])
                            && $data['terms'][ErpInvoiceIndexMap::EXTERNAL_REFERENCE] === $self->requestParameters[ErpInvoicePageSearchConstants::PARAMETER_EXTERNAL_REFERENCE];
                    },
                ),
            )->willReturn($this->boolQueryMock);
