...
class ReferenceErpInvoicePageSearchQueryExpanderPluginTest extends Unit
{
    /**
    ...
    /**
     * @var \FondOfOryx\Client\ErpInvoicePageSearch\Plugin\SearchExtension\ReferenceErpInvoicePageSearchQueryExpanderPlugin
     */
    protected $plugin;
    ...
    protected function _before(): void
    {
        ...
        $this->requestParameters = [
            ErpInvoicePageSearchConstants::PARAMETER_REFERENCE => [
                'FOO-BAR-1',
            ],
        ];

        $this->plugin = new ReferenceErpInvoicePageSearchQueryExpanderPlugin();
    }
            ...
            ->with(
                static::callback(
                    static function (Terms $terms) use ($self) {
                        ...
                        return isset($data['terms'][ErpInvoiceIndexMap::REFERENCE])
                            && $data['terms'][ErpInvoiceIndexMap::REFERENCE] === $self->requestParameters[ErpInvoicePageSearchConstants::PARAMETER_REFERENCE];
                    },
                ),
            )->willReturn($this->boolQueryMock);
